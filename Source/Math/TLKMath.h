...
const Scalar _Tolerance_		= 0.0000000001f;		// Scalar type tolerance 
...
inline CVector3f CVector3f::CrossProduct(CVector3f v1, CVector3f v2)
{
	...
	return (CVector3f(v1.y * v2.z - v1.z * v2.y, 
					  v1.z * v2.z - v1.z * v2.x, 
					  v1.x * v2.y - v1.y * v2.x));
}
...
{
	// this represents the cofactor by taking the determinant of the minor of each element
...
{
public:
	CVector3f pt1, pt2, pt3;
	CVector3f n;
	CTriangle(void)
	{
		pt1.MakeZero(); pt2.MakeZero(); pt3.MakeZero(); n.MakeZero();

	}
	~CTriangle(void){}
	CTriangle(CTriangle& tri);
	CTriangle(CVector3f p1, CVector3f p2, CVector3f p3);
...
{
	pt1 = tri.pt1; pt2 = tri.pt2; pt3 = tri.pt3; n = tri.n;
}
inline CTriangle::CTriangle(CVector3f p1, CVector3f p2, CVector3f p3)
{
...
inline void CTriangle::CreateNormal()
{
	...
	CVector3f edge1 = pt2 - pt1;
	CVector3f edge2 = pt3 = pt1;
